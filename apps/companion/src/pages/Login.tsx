    ...
    <div className="login-container">
      ...
      >
        <div className="login-header">
          ...
          <h1>Companion</h1>
          <p>Use the same account as two·do — one Firebase project, two apps.</p>
        </div>

        {isConfigError && (
          <div className="config-warning">
            <h3>Firebase Needs Configuration</h3>
            <p>Add your keys to <code>apps/companion/.env.local</code> (same <code>VITE_FIREBASE_*</code> as two·do).</p>
          </div>
        )}

        {error && !isConfigError && (
          <div style={{ color: '#f87171', fontSize: '0.875rem', marginTop: '1rem' }}>{error}</div>
        )}
